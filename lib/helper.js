...
const help = () => {
    ...
    console.log(
        chalk.cyan("-s [source-collection.json] (mandatory when using test-* modes)") + " This is the starting point file to enrich with the end result variables, if not present when mergning, a blank collection is created and upgraded with the variables"
    );
    console.log(
...
const saveCollection = (coolection, outputFileName) => {
    let data = JSON.stringify(coolection.toJSON(), null, "\t");
    //Writing the data
