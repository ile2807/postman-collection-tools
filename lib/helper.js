...
const help = () => {
    ...
    console.log(
        chalk.cyan("-s [source-collection.json] (mandatory when using t200 and clr commands)") + " This is the starting point file to enrich with the end result variables, if not present when mergning, a blank collection is created and upgraded with the variables"
    );
    console.log(
