...
const help = () => {
    ...
    console.log(
        chalk.yellow("    amcv") + " Adds missing collection variables that are refferenced in all requests but are not present in the collection. With this command, the -f flag is not used"
    );
    console.log(
